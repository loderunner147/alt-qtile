    ...
    Screen(
        bottom=bar.Bar(
            [
                ...
                widget.WindowName(font="JetBrains Mono",
                        fontsize = 15,
                        foreground = colors[1],
                        background = colors[9],
                ...
                #widget.DF(),
                widget.PulseVolume(font="JetBrains Mono",
                        fontsize = 15,
                        fmt="󰕾 {}",
                        foreground=colors[9],
                        background=colors[1],
                ...
                #widget.Spacer(
                        ...
                        #),
                #widget.Battery(font="JetBrains Mono",
                        #fontsize = 15,
                        ...
                        #),
                #widget.Memory(font="Jetbrains Mono",
                        #fontsize = 15,
                        #padding=5,
                        ...
                        #**arrow_powerlineRight,
                        #),
                #widget.CPU(font="Jetbrains Mono",
                        #fontsize = 15,
                        #padding=5,
                ...
                #widget.Bluetooth(),
                #widget.BatteryIcon(),
                widget.Clock(font="JetBrains Mono",
                        fontsize = 15,
                        foreground = colors[9],
                        background = colors[1],
                        format='󰥔 %H:%M:%S',
